        ...
        { key: "hr", label: S("hr"), entries: [
          {
            ...
            children: [
              { icon: UserCog, label: t("nav.employees"), path: "/users" },
              { icon: Users, label: "Карта сотрудников", path: "/employee-map" },
          ...
          },
          {
            ...
            children: [
              ...
              { icon: Brain, label: t("nav.predictiveAnalytics", { defaultValue: "Предиктивная аналитика" }), path: "/predictive-analytics" },
