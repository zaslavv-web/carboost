...
const rows: Row[] = [
  ...
  },
  {
    label: "Выручка",
    kind: "revenue",
    values: [null, null, 425, 225, 1075, 1525, 2400, 3925, 5475, 7675, 9900, 12350, 14600, 16850, 19100],
    total: 95525,
  },
  {
    label: "Прибыль",
    kind: "profit",
    values: [-550, -800, -775, -975, -1025, -575, 300, 1825, 3375, 5575, 7800, 10250, 12500, 14750, 17000],
    total: 43175,
  },
];
      ...
      <div className="flex h-full flex-col px-[70px] pt-[104px] pb-[60px]">
        ...
        <div className="mt-4 grid grid-cols-4 gap-4">
          {[
            ...
            { id: "s5b.k2", label: "Выручка за период", value: "95,5 млн руб." },
            { id: "s5b.k3", label: "Прибыль за период", value: "43,2 млн руб." },
            { id: "s5b.k4", label: "Выход в плюс", value: "апрель 2027" },
          ].map((k) => (
