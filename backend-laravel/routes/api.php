...
Route::get ('/university/scorm/course/{courseId}/asset/{path}', [ScormController::class, 'courseAsset'])->where('path', '.*');
...
Route::get ('/content-media/{path}', [StorageController::class, 'content'])->where('path', '.*');
...
Route::middleware(['auth:sanctum', 'effective.user'])->group(function () {
    ...
    Route::middleware(['verified.user', 'has.company'])->group(function () {
        ...
        Route::get   ('/performance-cycles/{id}/detail',    [\App\Http\Controllers\Api\PerformanceController::class, 'cycleDetail']);
